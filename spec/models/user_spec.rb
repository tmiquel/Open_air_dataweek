  ...
  context "validation" do
    ...
    describe "#first_name" do
      it "should not be valid without first_name" do
        bad_user = User.create(last_name: "Doe", email: "baduser@email.com", password: "foo_bar", adress: "25, Avenue des oliviers, 13200, Provence")
    ...
    describe "#last_name" do
      it "should not be valid without last_name" do
        bad_user = User.create(first_name: "John", email: "baduser@email.com", password: "foo_bar", adress: "25, Avenue des oliviers, 13200, Provence")
        expect(bad_user).not_to be_valid
